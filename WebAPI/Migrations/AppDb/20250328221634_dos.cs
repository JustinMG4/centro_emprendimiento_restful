        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmprendedorId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_negocio", x => x.Id);
                    table.ForeignKey(
                        name: "FK_negocio_AspNetUsers_EmprendedorId",
                        column: x => x.EmprendedorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_negocio_categoria_CategoriaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NegocioVendedores", x => new { x.ApplicationUserId, x.NegocioId });
                    table.ForeignKey(
                        name: "FK_NegocioVendedores_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NegocioVendedores_negocio_NegocioId",
                        column: x => x.NegocioId,
                        principalTable: "negocio",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RutaImagen = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cantidad = table.Column<int>(type: "int", nullable: false),
                    Total = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
                    TotalConIva = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    ProductoId = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_negocio_CategoriaId",
                table: "negocio",
                column: "CategoriaId");

            migrationBuilder.CreateIndex(
                name: "IX_negocio_EmprendedorId",
                table: "negocio",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NegocioVendedores_NegocioId",
                table: "NegocioVendedores",
                column: "NegocioId");
